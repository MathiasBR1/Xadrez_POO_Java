    ...
    public ArrayList<Casa> gerarMovimentos(ChessBoard tabuleiro) {
        ...
        if (row > 1 && col > 0) {
            if (tabuleiro.getPeca(row - 2, col - 1) == null) {
                ...
                if (tabuleiro.getPeca(row - 2, col - 1) != null && tabuleiro.getPeca(row - 2, col - 1).getColor().equals("Preto")) {
                    Casa aux = new Casa(row - 2, col - 1);
                    movimentos.add(aux);
                }
            }
        ...
        if (row > 1 && col < 7) {
            if (tabuleiro.getPeca(row - 2, col + 1) == null) {
                ...
                if (tabuleiro.getPeca(row - 2, col + 1).getColor().equals("Preto")) {
                    Casa aux = new Casa(row - 2, col + 1);
                    movimentos.add(aux);
                }
            }
        ...
        if (row > 0 && col > 1) {
            if (tabuleiro.getPeca(row - 1, col - 2) == null) {
                ...
                if (tabuleiro.getPeca(row - 1, col - 2) != null && tabuleiro.getPeca(row - 1, col - 2).getColor().equals("Preto")) {
                    Casa aux = new Casa(row - 1, col - 2);
                    movimentos.add(aux);
                }
            }
